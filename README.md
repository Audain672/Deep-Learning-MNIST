...
Dans MNIST, la couche Dense(512, relu, input_shape=(784,)) transforme les 784 pixels en 512 caractéristiques abstraites.

- 2. Couche Dropout
Le Dropout est une régularisation pour éviter le surapprentissage.
...
- 3. Fonction softmax en sortie
Dans MNIST (10 classes), softmax est idéale car :
