...
with mlflow.start_run():
    ...
    (x_train, y_train), (x_test, y_test) = mlflow.keras.datasets.mnist.load_data()
    ...
    model = mlflow.keras.Sequential([
        mlflow.keras.layers.Dense(DENSE_UNITS_LAYER1, activation ='relu', input_shape =(784, ) ),
        mlflow.keras.layers.Dropout(DROPOUT_RATE),
        mlflow.keras.layers.Dense(DENSE_UNITS_OUTPUT, activation ='softmax')
    ])
